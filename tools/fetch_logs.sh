...
mos call Config.Set '{"config": {"file_logger": {"enable": false } }, "reboot": false, "save": false}'
# FLush everything, especially important for LFS.
mos call FileLog.Flush
while true; do
...
# Re-enable logs.
mos call Config.Set '{"config": {"file_logger": {"enable": true } }, "reboot": false, "save": false}'
